...
import { pickupTranslations } from '@/features/pickups/translations';
...
const SchedulePickup = () => {
  ...
  const t = pickupTranslations[language.code as keyof typeof pickupTranslations] || pickupTranslations.en;
